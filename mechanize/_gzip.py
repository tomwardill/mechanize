...
def compress_readable_output(src_file, compress_level=6):
    ...
    while True:
        ...
        yield data
    yield zobj.flush() + struct.pack(b"<LL", crc & long(0xffffffff), size)
...
class UnzipWrapper:
    def __init__(self, fp):
        ...
        self.__data = b''
        self.__crc = zlib.crc32(self.__data) & long(0xffffffff)
        self.__fp = fp
        self.__size = 0
    ...
    def read(self, sz=-1):
        ...
        if not self.__is_fully_read:
            ...
            if self.__decoder.unused_data:
                ...
                if (crc & long(0xffffffff)) != (self.__crc & long(0xffffffff)):
                    raise ValueError(
